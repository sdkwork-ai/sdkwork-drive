...
This directory is the local SDKWork component contract for `sdkwork-drive-pc-admin-core`.

- Component root: `sdkwork-drive/apps/sdkwork-drive-pc/packages/sdkwork-drive-pc-admin-core`
