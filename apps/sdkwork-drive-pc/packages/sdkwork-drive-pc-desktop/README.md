...
Domain: drive
Capability: pc-desktop
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `sdkwork-drive-pc-desktop`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
