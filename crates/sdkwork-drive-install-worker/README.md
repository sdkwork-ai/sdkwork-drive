...
Domain: drive
Capability: install
Package type: rust-worker
Status: standard

This README is the SDKWork module entrypoint for `sdkwork-drive-install-worker`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
