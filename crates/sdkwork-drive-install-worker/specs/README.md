...
This directory is the local SDKWork component contract for `sdkwork-drive-install-worker`.

- Component root: `sdkwork-drive/crates/sdkwork-drive-install-worker`
