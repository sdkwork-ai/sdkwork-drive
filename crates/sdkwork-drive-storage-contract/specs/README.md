...
This directory is the local SDKWork component contract for `sdkwork-drive-storage-contract`.

- Component root: `sdkwork-drive/crates/sdkwork-drive-storage-contract`
