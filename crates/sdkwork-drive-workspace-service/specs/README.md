...
This directory is the local SDKWork component contract for `sdkwork-drive-workspace-service`.

- Component root: `sdkwork-drive/crates/sdkwork-drive-workspace-service`
