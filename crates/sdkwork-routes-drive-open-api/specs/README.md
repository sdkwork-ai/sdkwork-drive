...
This directory is the local SDKWork component contract for `sdkwork-routes-drive-open-api`.

- Component root: `sdkwork-drive/crates/sdkwork-routes-drive-open-api`
