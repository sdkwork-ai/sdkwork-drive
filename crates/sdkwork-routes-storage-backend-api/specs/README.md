...
This directory is the local SDKWork component contract for `sdkwork-routes-storage-backend-api`.

- Component root: `sdkwork-drive/crates/sdkwork-routes-storage-backend-api`
