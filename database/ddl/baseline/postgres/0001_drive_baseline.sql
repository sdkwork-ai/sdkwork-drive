-- SDKWork drive consolidated initialization baseline (postgres)
...
-- baseline source: ddl/baseline/postgres/0001_drive_baseline.sql
-- SDKWork drive consolidated initialization baseline (postgres)
-- Generated by reset-database-initialization-state.mjs
-- Application is in initialization state: full DDL lives here; migrations/ is reserved for post-GA changes.

-- baseline source: ddl/baseline/postgres/0001_drive_legacy_baseline.sql
...
-- folded migration: migrations/postgres/0002_drive_outbox_pending_dispatch_index.up.sql
-- sdkwork:migration
-- version: 0002
-- engine: postgres
-- module: drive
...
-- folded migration: migrations/postgres/0008_drive_storage_provider_kind.up.sql
-- sdkwork:migration
-- version: 0008
-- engine: postgres
-- module: drive
-- description: Built-in storage provider kind registry with enable/disable switch.
