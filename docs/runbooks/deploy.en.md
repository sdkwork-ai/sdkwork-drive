# Runbook — sdkwork-drive deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-drive-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-drive/bundle`, loads the image, starts
