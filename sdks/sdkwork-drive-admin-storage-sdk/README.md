...
Domain: drive
Capability: drive-storage-admin
Package type: sdk-family
Status: standardized

This README is the SDKWork module entrypoint for `sdkwork-drive-admin-storage-sdk`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
