...
```bash
pip install sdkwork-drive-admin-storage-sdk-generated-python
```

## Quick Start

```python
from sdkwork_drive_admin_storage_sdk_generated_python import SdkworkCustomClient, SdkConfig
