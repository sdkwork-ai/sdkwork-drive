...
```bash
npm install sdkwork-drive-admin-storage-sdk-generated-typescript
# or
yarn add sdkwork-drive-admin-storage-sdk-generated-typescript
# or
pnpm add sdkwork-drive-admin-storage-sdk-generated-typescript
```

## Quick Start

```typescript
import { SdkworkCustomClient } from 'sdkwork-drive-admin-storage-sdk-generated-typescript';
...
```typescript
const client = new SdkworkCustomClient({ baseUrl: 'http://127.0.0.1:18080' });
client.setApiKey('your-api-key');
