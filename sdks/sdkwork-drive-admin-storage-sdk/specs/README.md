...
This directory is the local SDKWork component contract for `sdkwork-drive-admin-storage-sdk`.

- Component root: `sdkwork-drive/sdks/sdkwork-drive-admin-storage-sdk`
