...
export function planUploaderParts(file, chunkSizeBytes = DEFAULT_UPLOADER_CHUNK_SIZE_BYTES) {
...
export function inferUploaderContentType(file, fallback = "application/octet-stream") {
...
export function inferUploaderFileName(file) {
    return file.name?.trim() || "upload.bin";
}
//# sourceMappingURL=uploadPlanner.js.map