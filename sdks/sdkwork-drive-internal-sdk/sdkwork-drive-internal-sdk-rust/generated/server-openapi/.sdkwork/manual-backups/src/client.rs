...
use crate::api::DriveInternalPublishingApi;
...
impl SdkworkCustomClient {
    ...
    pub fn drive_internal_publishing(&self) -> DriveInternalPublishingApi {
        DriveInternalPublishingApi::new(Arc::clone(&self.http))
    }
}
