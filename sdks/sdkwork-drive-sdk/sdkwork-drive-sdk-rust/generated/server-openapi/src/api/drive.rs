...
use crate::models::{CreateOpenDownloadUrlRequest, OpenShareLinksDownloadUrlsCreateResponse201, OpenShareLinksRetrieveResponse};
...
impl DriveApi {
    ...
    pub async fn open_share_links_retrieve(&self, token: &str, access_code: Option<&str>) -> Result<OpenShareLinksRetrieveResponse, SdkworkError> {
