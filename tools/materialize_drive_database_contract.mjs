...
const baselinePath = path.join(
  root,
  'database/ddl/baseline/postgres/0001_drive_baseline.sql',
);
...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'dr_', owner: 'drive-platform', domain: 'drive' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into drive database contract\n`);
